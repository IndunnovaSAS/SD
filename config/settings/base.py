"""
Django base settings for SD LMS project.
...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", default="sdlms"),
        "USER": config("DB_USER", default="sdlms"),
        "PASSWORD": config("DB_PASSWORD", default="sdlms"),
...
SPECTACULAR_SETTINGS = {
    "TITLE": "SD LMS API",
    "DESCRIPTION": "API para el Sistema de Gestión de Capacitaciones de S.D. S.A.S.",
    "VERSION": "1.0.0",
...
# TOTP 2FA Configuration (Google Authenticator)
TOTP_2FA_REQUIRED = config("TOTP_2FA_REQUIRED", default=True, cast=bool)

# SMS OTP Configuration (disabled by default - requires Twilio paid account)
